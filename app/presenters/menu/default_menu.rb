    ...
    class << self
      ...
      def automate_menu_section
        Menu::Section.new(:automate, N_("Automate"), 'fa fa-recycle', [
          ...
          Menu::Item.new('generic_object_definitions', N_('Generic Objects'), 'generic_object_definitions', {:feature => 'generic_object_definition', :any => true}, '/generic_object_definition'),
